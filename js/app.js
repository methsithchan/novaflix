...
function app() {
    return {
        ...
        // Custom player UI (F1 replays only)
        f1ReplayPlayer: false,
        playerTitle: '',
        playerMode: 'embed',
        playerPaused: true,
        playerCurrentTime: 0,
        ...
        onPlayerKeydown(event) {
            if (!this.isPlayingInModal || !this.f1ReplayPlayer) return;
        ...
        playGlobalVideo(url, isDirect = false, title = '', f1Replay = false) {
            console.log("Playing Global Video:", url);
            this.f1ReplayPlayer = !!f1Replay;
            ...
            } else if (isDirect && url && this.f1ReplayPlayer) {
                this.$nextTick(() => {
                    const video = document.getElementById('modalPlayerVideo');
                    if (!video) return;
                    video.src = url;
        ...
        openF1StreamPlayer() {
            ...
            this.f1ReplayPlayer = false;
            this.isPlayingInModal = false;
            this.modalContent = { id: 999999, title: serverName, media_type: 'live_sport' };
